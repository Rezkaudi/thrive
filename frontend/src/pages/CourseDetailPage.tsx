...
export const CourseDetailPage: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      setSelectedCourse(
        coursesRes.data.find((item: Course) => item.id === courseId)
      );
  ...
  const fetchLessons = async (courseId: string) => {
    try {
      ...
      const lessonsWithLocks = calculateLessonLocks(
        response.data,
        selectedCourse
      );
                            ...
                            <ListItemText
                              ...
                              secondary={
                                <Typography
                                  variant="caption"
                                  color={
                                    isSelected ? "inherit" : "text.secondary"
                                  }
                                  sx={{
                    ...
                    >
                      ...
                      >
                        ...
                        <Typography
                          ...
                          sx={{ mb: 4, opacity: 0.9 }}
                        >
                          Subscribe to unlock all lessons and continue your
                          learning journey
                        </Typography>
                        <Button
                          variant="contained"
                            ...
                            <>
                              {selectedLesson.contentUrl ? (
                                ...
                                <Alert
                                  ...
                                  sx={{ mb: 4, borderRadius: 3 }}
                                >
                                  Content URL not available. Please contact
                                  support.
                                </Alert>
                              )}
                            </>
