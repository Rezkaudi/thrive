  ...
  return (
    <Box sx={{ padding: 4, maxWidth: "900px", margin: "0 auto" }}>
      ...
      <Grid container spacing={4} sx={{ mb: 4 }}>
            ...
            <Stack spacing={2}>
              {content.items?.map((item: any) => (
                <Button
                  ...
                  onClick={() => {
                    const rightItem = content.items?.find(
                      (i: any) => i.pair === item.pair
                    );
                    if (rightItem) {
                  ...
                  sx={{
                    ...
                    minHeight: "80px",
                    borderRadius: 2,
                    backgroundColor: connections[item.left]
                      ? "success.main"
                      : "background.paper",
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <Paper sx={{ p: 3, bgcolor: "secondary.50", borderRadius: 3 }}>
            ...
            <Stack spacing={2}>
              {content.items?.map((item: any) => {
                const isConnected = Object.values(connections).includes(
                  item.right
                );
                return (
                  <Paper
      ...
      <Box sx={{ textAlign: "center" }}>
        ...
        >
          Check Connections ({Object.keys(connections).length}/
